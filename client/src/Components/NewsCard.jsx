  ...
  return (<>
    <div className="Ncard">
        ...
        <div className="Ncard-content">
            ...
            <button onClick={props.onLike} style={{position:'absolute',right:'20px',bottom:'20px',backgroundColor:'inherit',border:'none'}} >
                {/* heart svg */}
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" viewBox="0 0 16 16" style={{color:props.liked?'red':'lightgrey'}}>
